...
class ActorWhoDancesIntroForm extends Component {
  ...
  renderAdditional() {
    ...
    return (
      <Typography className={classes.descriptionText}>
        {`Since you are an Actor Who Dances, `}
        ...
        you may wish to categorize yourself on this site as an Actor Who Moves and complete the Movement
...
export default withStyles(styles)(ActorWhoDancesIntroForm);

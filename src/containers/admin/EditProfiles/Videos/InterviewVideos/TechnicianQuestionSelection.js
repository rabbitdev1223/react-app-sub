...
class TechnicianQuestionSelection extends Component {
  state = {
  ...
  render() {
    const { subPositionType } = this.props;
      ...
      <Grid container spacing={16} justify="center" alignItems="center">
        ...
        <Grid item xs={12}>
          <FormControl component="fieldset">
            <FormLabel component="legend">{`${subPositionType ? subPositionType.name : ''} Technician Questions:`}</FormLabel>
            <RadioGroup
...
export default withStyles(adminStyles)(TechnicianQuestionSelection);
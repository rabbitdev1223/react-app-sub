...
class SearchViewFavorites extends React.Component  {
  state = {
    profileId: 0,
    userIds: [],
    noteTypes: [
      defaultValues.USER_NOTE_TYPE.SEARCH, 
      defaultValues.USER_NOTE_TYPE.VIEW,
      defaultValues.USER_NOTE_TYPE.FAVORITE
    ]
  };
  ...
  render() {
    ...
    return (
      <AdminForm
        talent={profile}
        showName
        formSubTitle="SEARCHES, VIEWS, AND FAVORITES"
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(adminStyles)(SearchViewFavorites));
